...
int main()
{
        ...
        STLinkBook *pInsert = CreatLink();
        phead->number = 1;
        phead->next = p1;
        p1->number = 2;
        p1->next = p2;
        p2->number = 3;
        pInsert->number = 0xFFFF;
